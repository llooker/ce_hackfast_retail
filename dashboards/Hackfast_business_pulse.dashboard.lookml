- dashboard: retail_business_pulse
  title: Retail - Business Pulse
  layout: newspaper
  ...
  - title: Percent of Cohort Still Active by Traffic Source
    ...
    dynamic_fields: [{table_calculation: pct_cohort_still_active, label: Pct Cohort
        ...
        value_format_name: percent_0, _kind_hint: measure, _type_hint: number, is_disabled: false}]
    x_axis_gridlines: false
    y_axis_gridlines: false
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: pct_cohort_still_active,
        ...
        tickDensity: custom, tickDensityCustom: 37, type: linear}]
    y_axis_max: ['50']
