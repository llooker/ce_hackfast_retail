- dashboard: retail_cohort_analysis_overview
  title: Retail - Cohort Analysis Overview
  layout: newspaper
  description: ''
  elements:
  ...
  - title: New Arrivals
    ...
    explore: order_items
    type: looker_grid
    fields: [products.item_name, inventory_items.created_date]
    filters:
    ...
    column_order: ["$$$_row_numbers_$$$", products.brand, products.item_name, products.category,
      products.count]
    series_column_widths:
      products.brand: 183
